rule partition_vcf_file:
    input:
        ...
        phased_vcfgz = "Output/{project}/VCF/{filename}.chr19.53_to_56mb.dose.vcf.gz"
    output:
        subset_filename = "Output/{project}/VCF/{filename}.chr19.53_to_56mb.dose.{partition_id}.vcf.gz"
